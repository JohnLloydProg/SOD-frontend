...
@Component({
  selector: 'app-class-types-classes-page',
  imports: [StackCarousel, SlideCarousel, ClassCard, RouterLink],
  templateUrl: './class-types-classes-page.html',
  styleUrl: './class-types-classes-page.css',
})
export class TypesClassesPage implements OnInit {
